...
struct AnimationConfig{
    ...
    init(cards:[Card]? = [Card.init(bgImage: "0.png", strTitle: "科学SCIENCE", items: [Model(),Model(),Model()]),
                          Card.init(bgImage: "1.png", strTitle: "体育SPORTS", items: [Model(),Model(),Model(),Model(),Model(),Model()]),
                          Card.init(bgImage: "2.png", strTitle: "好友FRIENDS", items: [Model(),Model(),Model(),Model()]),
                          Card.init(bgImage: "3.png", strTitle: "我的STYLISH", items: [Model(),Model()]) ])
    {
